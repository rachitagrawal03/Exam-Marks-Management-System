...
const EXAM_TYPES = ['CT1', 'CT2', 'UT', 'Half Yearly', 'Final Exam'];
    ...
    <div>
      ...
      <div className="relative">
        <select
          ...
          className="w-full appearance-none bg-white px-3.5 py-2.5 border border-slate-300 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-500 transition duration-200 disabled:bg-slate-100 disabled:text-slate-500 disabled:cursor-not-allowed"
          required
